...
public final class RejectionDecoder
{
    ...
    private final RejectionDecoder parentMessage = this;
    ...
    public RejectionDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public RejectionDecoder sbeRewind()
    {
    ...
    public SessionRejectionReason rejectionReason()
    {
        return SessionRejectionReason.get(((short)(buffer.getByte(offset + 0) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[Rejection](sbeTemplateId=");
    ...
    public RejectionDecoder sbeSkip()
    {
        sbeRewind();
